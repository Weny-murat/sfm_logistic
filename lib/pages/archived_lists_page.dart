...
class _ArchivedListsPageState extends State<ArchivedListsPage> {
  ...
  Future<void> fetch() async {
    ...
    final result = await context.read<ArchivedListsCubit>().fetchLists();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Arşivlenmiş Yükleme Listeleri')),
      body: SafeArea(
        child: switch (isBusy) {
          true => Center(child: LoadingIndicator()),

          false => BlocBuilder<ArchivedListsCubit, List<LoadingList>>(
